...
def run_hparam(params, file_name="comp_sr_model.csv", path_integration = True):
    ...
    progress_counter = 0
    num_monsters = 12
    data_frame = np.zeros((len(subj), 1))
...
### params from best model that optimizes 3 hyperparameters
params = [1.742, 3.384, 0.001] ## spatial lengthscale, temporal lengthscale, temporal learning rate



run_hparam(params, file_name="compositional_simulated_choices_3params.csv", path_integration = True)
