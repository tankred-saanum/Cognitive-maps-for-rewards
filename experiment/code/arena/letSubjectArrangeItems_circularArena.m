...
initializeArena(hf,options.bgColor);
ud=get(hf,'UserData');
...
%% --------------------------------------------------------------------------
function initializeArena(hf,col)
moveImages('reset');
...
% draw circular arena
ud.h_arena=rectangle('Position',[ud.squareObjWidth+ud.arenaMargin ud.squareObjWidth+ud.arenaMargin 2*ud.arenaRadius 2*ud.arenaRadius],'Curvature',[1 1],'EdgeColor',[1 1 1],'FaceColor',col);
