function contrast_817(subj,session)
...
stats.con.consess{concounter}.tcon.name      = 'unchosen_value'; %name
...
stats.con.consess{concounter}.tcon.name      = 'signed_RPE_comp_at_feedback'; %name
