function contrast_517(subj,session)
...
stats.con.consess{concounter}.tcon.name      = 'chosen_value'; %name
stats.con.consess{concounter}.tcon.convec    = chosen;                   %contrast vector
stats.con.consess{concounter}.tcon.sessrep   = 'none';                   %replicate vector over sessions
concounter = concounter+1;


% 3. RPE euc vs temp at choice
ci_pos = 3;
block = col.block;
for i = 1:nblocks
    block(i,ci_pos) = 1;
...
stats.con.consess{concounter}.tcon.name      = 'RPE_euc_vs_temp_at_choice'; %name
...
stats.con.consess{concounter}.tcon.name      = 'feedback_onset'; %name
...
stats.con.consess{concounter}.tcon.name      = 'RPE_euc_vs_temp_at_feedback'; %name
